...
| [18-console-data-list.md](./PUB-18-console-data-list.md) | **Console DataList**（Frame 布局、URL scope、分页、列设置 SSOT） |
...
| 2026-06-10 | **PUB-18** | Console DataList 企业级列表 SSOT：Frame 内滚动、URL 命名空间、Turso 分页、列设置与 Runs/评估接入纪律 |
